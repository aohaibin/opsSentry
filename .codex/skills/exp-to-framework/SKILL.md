---
name: exp-to-framework
description: |
  子项目到原框架的经验输送员，抽取通用的坑、模式、配置、工具函数、skill 条目，建议同步回原框架。

  触发场景：
  - 子项目里踩到的坑值得反哺给上游框架
  - 需要分析近期 commit / 未提交 diff 提炼通用经验
  - 需要把本项目验证过的方案沉淀到框架 skills

  触发词：反哺框架、沉淀到框架、exp-to-framework、经验回流、通用经验、上游框架、feedback-to-framework
---
